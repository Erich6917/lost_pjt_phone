...
public class FromHbaseToPgRunner extends Configured implements Tool {
...
//				count++;
	...
	public static void main(String[] args) throws Exception {
		...
		int re = ToolRunner.run(configuration, new FromHbaseToPgRunner(), args);
		System.exit(re);
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(FromHbaseToPgRunner.class);
		Scan scan = new Scan();
